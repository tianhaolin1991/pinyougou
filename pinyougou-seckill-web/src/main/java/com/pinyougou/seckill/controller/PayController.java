...
public class PayController {
	...
	public Map createNative(){
		...
		if(seckillOrder!=null){
			return weixinPayService.createNativeOrder(seckillOrder.getId()+"", (long)(seckillOrder.getMoney().doubleValue()*100)+"");
		}else{
			return new HashMap<>();
		}		
	}
	...
	public Result queryPayStatus(String out_trade_no){
		...
		while(true){
			...
			Map<String,String> map = weixinPayService.getPayResult(out_trade_no);//调用查询
			if(map==null){
